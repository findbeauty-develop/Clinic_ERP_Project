...
"
        ...
        <section className="rounded-xl p-6 shadow-md border-2 border-amber-300 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/20 dark:border-amber-500/50">
          ...
          {loading ? (
            ...
            <div className="overflow-auto white-scrollbar rounded-lg border border-amber-200/60 bg-white dark:bg-slate-900/50 dark:border-amber-500/30 max-h-72">
        ...
        <section className="bg-white rounded-lg p-6 shadow-sm border border-red-200 bg-red-50/30">
          ...
          {loading ? (
            ...
            <div className="overflow-auto white-scrollbar max-h-72 rounded-lg bg-white">
