        ...
        <div className="w-full max-w-md">
          ...
          <div className="rounded-2xl bg-white p-6 shadow-xl sm:p-8">
            ...
            <div className="mb-8 flex flex-col items-center">
              <div className="mb-4 flex h-40 w-40 items-center justify-center rounded-full bg-white shadow-lg">
                ...
                <div className="flex h-28 w-28 items-center justify-center rounded-full">
                  ...
                  <img src="/logo/Jaclit_Logo.svg" alt="Jaclit Logo" className="h-full w-full object-contain items-center justify-center" />
                </div>
              </div>
